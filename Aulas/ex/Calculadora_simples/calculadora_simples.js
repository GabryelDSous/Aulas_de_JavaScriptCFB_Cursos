...
const op=[
    ...
    ()=>{
        const valor=[document.querySelector("#valor1").value,document.getElementById("valor2").value]
        res.value=Number(valor[0])*Number(valor[1])
    },
    ()=>{
        const val=[document.getElementById("valor1").value,document.querySelector("#valor2").value]
        res.value=Number(val[0])/Number(val[1])
    }
    ]
